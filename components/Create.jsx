                                ...
                                <div class="py-8 sm:py-20 pl-8 sm:pl-[84px] pr-8 sm:pr-20">
                                    <form>
                                        ...
                                        <div class="mb-5 relative">
                                            ...
                                            <input type="text" placeholder="Revenue royalty percentage" class="w-full border border-white/[0.12] bg-transparent rounded-lg focus:border-purple pl-14 pr-4 py-3.5 font-medium outline-none focus-visible:shadow-none text-gray-200" fdprocessedid="ghc7l5" />
                                        </div>
                                        <input
                                            id="ipfs_file"
                                            type="file"
                                        ...
                                        <div class="mb-2 relative">
                                            ...
                                            <button type="button" onClick={uploadFile} class="w-full border border-white/[0.12] bg-transparent rounded-lg focus:border-purple pl-14 pr-4 py-3.5 font-medium outline-none focus-visible:shadow-none text-white" fdprocessedid="y6prfd">
                                                Upload logo
                                            </button>
                                        </div>
                                        {allfile.length > 0 && (
                                            <div className="text-sm text-gray-400 mb-4 font-semibold">
                                                {allfile[0].name} files choosen
                                            </div>
                                        )}
                                        <button onClick={(e) => mint(e)} class={`${style.heroButtonGradient} flex justify-center w-full rounded-lg py-3 px-7 text-white font-medium ease-in duration-300 hover:opacity-80`} fdprocessedid="84ofed">
                                            Mint
                                        </button>
                                    </form>
                                </div>
