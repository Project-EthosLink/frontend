                    ...
                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                        <div className="px-6 bg-slate-200 rounded-md border-[1px] border-gray-600">
                            ...
                            <div className="py-10 text-center">
                                ...
                                <button className="bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150">Attest</button>
                            </div>
                        </div>
                    </div>
                </div>
