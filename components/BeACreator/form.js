                ...
                <TabPanel value={0}>
                    <div className='flex flex-col items-center justify-center h-[70vh]'>
                        ...
                        <div className='mt-[120px] text-center'>
                            <strong>
                                <span className=' underline text-xl'>Note:</span> After veriying your World ID, you will be redirected to  <span className=' underline text-purple-900'>Homepage</span>. So, again You have to come to this page and fill Your Personal details.<br />
                                <span className=' underline text-purple-900'>Until You fill your personal details users will Not be able to find you</span>
                            </strong>
                        </div>
                ...
                <TabPanel value={1}>
                    <form className=' w-3/4 flex justify-center flex-col items-center m-auto'>
                        <div className="mb-6 w-full">
                            ...
                            <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Arya" required />
                        </div>
                        <div className="mb-6 w-full">
                        ...
                        <div className="mb-6 w-full">
                            ...
                            <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Videos, Blogs" required />
                        </div>
                        <div className="mb-6 w-full">
